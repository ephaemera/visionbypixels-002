<?php
/*
Template Name: Single Panorama Template
*/
?>
...
<section class="single-view panorama">
    <div class="wrap">
        <div class="row">
            ...
            <div class="small-12 columns">
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?> class="single-text">
                    <h2 class="panorama"><?php the_title(); ?></h2>
                    <?php the_content(); ?>
                </article><!-- single-text -->
...
</section><!-- single-view horizontal -->
...
<section class="grid gallery related">
    <div class="wrap">
       <h3>Related Items</h3>
        <div class="row small-up-1 medium-up-2 large-up-3 small-centered" id="masonry-container">
